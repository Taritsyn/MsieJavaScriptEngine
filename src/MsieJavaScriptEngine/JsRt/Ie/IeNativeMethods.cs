...
namespace MsieJavaScriptEngine.JsRt.Ie
{
	...
	internal static class IeNativeMethods
	{
		...
		[DllImport(DllName.JScript9, CallingConvention = DefaultCallingConvention, CharSet = CharSet.Unicode)]
		...
		[DllImport(DllName.JScript9, CallingConvention = DefaultCallingConvention, CharSet = CharSet.Unicode, EntryPoint = "JsAddRef")]
		...
		[DllImport(DllName.JScript9, CallingConvention = DefaultCallingConvention, CharSet = CharSet.Unicode, EntryPoint = "JsRelease")]
