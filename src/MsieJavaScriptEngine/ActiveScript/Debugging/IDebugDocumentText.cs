...
namespace MsieJavaScriptEngine.ActiveScript.Debugging
{
	...
	internal interface IDebugDocumentText // : IDebugDocument
	{
		...
		/// </summary>
		/// <param name="numLines">Number of lines in the document. If this parameter is <c>null</c>,
		/// the method does not return a value</param>
		/// <param name="length">Number of characters in the document. If this parameter is <c>null</c>,
		/// the method does not return a value</param>
		void GetSize(
		...
		/// If this parameter is <c>null</c>, the method does not return a value</param>
		...
		/// <paramref name="maxChars"/> characters. If this parameter is <c>null</c>, the method does not return characters.</param>
		/// <param name="pAttrs">A character attribute buffer. The buffer must be large enough to hold
		/// <paramref name="maxChars"/> characters. If this parameter is <c>null</c>, the method does not return attributes.</param>
