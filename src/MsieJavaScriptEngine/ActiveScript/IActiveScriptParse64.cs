...
namespace MsieJavaScriptEngine.ActiveScript
{
	...
	/// IPersist.Load, IPersist.InitNew, or <see cref="IActiveScriptParse64.InitNew"/>. The semantics of
	...
	/// <see cref="IActiveScriptParse64.InitNew"/> and IPersist.Load, nor is it valid to call
	/// IPersist.InitNew, <see cref="IActiveScriptParse64.InitNew"/>, or IPersist.Load more than once.
	/// </remarks>
	[ComImport]
	...
	internal interface IActiveScriptParse64
	{
		...
		/// <see cref="IActiveScriptParse64.ParseScriptText"/> returns DISP_E_EXCEPTION.</param>
